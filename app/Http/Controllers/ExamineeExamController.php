...
class ExamineeExamController extends Controller
{
    /**
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->hasFile('photo')) {
            ...
            $examFee = IteeExamFee::with(['exam_type', 'exam_category'])->find($request->itee_exam_fees_id);
            $message = 'Success! Your exam in review.';
            return view('examinee.dashboard-my-courses', compact('message', 'examFee'));
    }
