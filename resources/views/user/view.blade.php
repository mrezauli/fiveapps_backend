                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4 mx-5">
                        ...
                        <div class="flex justify-center items-center gap-3">
                            <a href="{{ route('user.edit', $staff->id) }}" class="select-none bg-red-500 hover:bg-red-700 rounded shadow-md flex justify-center items-center flex-col gap-2 transition-shadow hover:shadow-lg p-2 px-6">
                    ...
                    <div class="mt-6 bg-gray-100 rounded py-5 mx-5 px-6 flex flex-col justify-center items-start gap-1">
                        ...
                        @if (starts_with($staff->user_type ?? '', 'nttn'))
                            <div class="flex justify-between items-center">
