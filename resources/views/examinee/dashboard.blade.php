                                                            ...
                                                            <ul class="generic-list-item">
                                                                ...
                                                                <li class="pb-2">
                                                                    <form method="POST"
                                                                        ...
                                                                        <a class="shadow-none btn theme-btn theme-btn-sm lh-26"
                                                                            href="{{ route('logout') }}"
                                                                            onclick="event.preventDefault();
                                                this.closest('form').submit();"
                                                                            previewlistener="true">{{ __('Log Out') }}</a>
                                                                    </form>
                                                                </li>
                                                                <li>
                                                                    <div class="section-block"></div>
            ...
            <ul class="pt-1 pb-2 generic-list-item off-canvas-menu-list border-bottom border-bottom-gray">
                ...
                <li class="pb-2">
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <a class="shadow-none btn theme-btn theme-btn-sm lh-26" href="{{ route('logout') }}"
                            onclick="event.preventDefault();
                                                this.closest('form').submit();"
                            previewlistener="true">{{ __('Log Out') }}</a>
                    </form>
    ...
    <section class="dashboard-area">
        <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
            ...
            <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
                ...
                {{-- <li><a href="{{ route('login') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px"
...
================================= -->
    ...
    <script src="{{ asset('aduca/js/chart.js') }}"></script>
    <script src="{{ asset('aduca/js/doughnut-chart.js') }}"></script>
    <script src="{{ asset('aduca/js/bar-chart.js') }}"></script>
    <script src="{{ asset('aduca/js/line-chart.js') }}"></script>
