                        ...
                        <div class="card-body">
                            ...
                            <form method="post" class="row">
                                ...
                                <div class="btn-box col-lg-12">
                                    ...
                                    <p class="pb-1 text-black-50"><i class="mr-1 la la-lock fs-24"></i>Secure
                                        Connection</p>
                            ...
                            <div class="payment-option-wrap">
                                <div class="payment-tab is-active">
                                    ...
                                    <div class="payment-tab-content">
                                        <p class="fs-15 lh-24">Make your payment directly into our bank account. Please
                        ...
                        <div class="card-body">
                            ...
                            <div class="order-details-lists">
                                <div class="pb-3 mb-3 media media-card border-bottom border-bottom-gray">
                                    ...
                                    <div class="media-body">
                                        <h5 class="pb-2 fs-15"><a href="course-details.html">The Complete JavaScript
                                                Course 2021: From Zero to Expert!</a></h5>
                                        <p class="text-black font-weight-semi-bold lh-18">$12.99 <span
                                                class="before-price fs-14">$129.99</span></p>
                                    </div>
                            ...
                            <a href="course-grid.html" class="btn-text"><i class="mr-1 la la-edit"></i>Edit</a>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <div class="pt-3 btn-box border-top border-top-gray">
                                <p class="mb-2 fs-14 lh-22">Aduca is required by law to collect applicable transaction
                                    taxes for purchases made in certain tax jurisdictions.</p>
                                <p class="mb-3 fs-14 lh-22">By completing your purchase you agree to these <a
    ...
    <section class="footer-area pt-100px bg-gray">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="footer-item">
                        <h3 class="pb-2 fs-20 font-weight-semi-bold">Newsletter</h3>
                        <div class="divider border-bottom-0"><span></span></div>
                        <form method="post" class="subscriber-form">
                            ...
                            <div class="form-group">
                                ...
                                <button class="mt-3 btn theme-btn w-100" type="button">Subscribe <i
