                    ...
                    <form action="{{ route('bkiict.user.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-select id="user_type" name="user_type" class="mt-1 block w-full" required>
                                ...
                                <option @selected(in_array(old('user_type'), ['bkiict_student'])) value="bkiict_student">Student</option>
                                <option @selected(in_array(old('user_type'), ['bkiict_admin'])) value="bkiict_admin">BKIICT Admin</option>
                            </x-select>
